...
class Store implements AppChrome {
  ...
  @observable allTasks :TrainingTask[] = [
    ...
    { id: 'course-c', title: 'Course C', summary: "Outdoor weekend - Intro to SAR", category: 'session', hours: 32.5, prereqs: ['course-b', /*'ESAR F/A - Basic' /*, 'Background Check', 'LFL Registration'*/], offerings: [] },
